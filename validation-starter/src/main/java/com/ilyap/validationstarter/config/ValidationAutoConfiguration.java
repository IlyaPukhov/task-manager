...
/**
 * {@link EnableAutoConfiguration Auto-configuration} for Validation.
 * <p>
...
@ConditionalOnClass(ValidationProperties.class)
@ConditionalOnProperty(prefix = "application.validation", name = "enabled", havingValue = "true")
public class ValidationAutoConfiguration {

    @PostConstruct
    void init() {
        log.info("ValidationAutoConfiguration initialized");
    }
}
